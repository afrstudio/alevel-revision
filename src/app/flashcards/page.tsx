...
function FlashcardsPageInner() {
  ...
  if (!selected) {
    return <SubjectPicker title="Flashcards" subjects={subjects} onSelect={setSelected} />;
  }
  ...
  return (
    <div className="fade-in">
      ...
      <FlashcardPractice flashcards={data.flashcards} subject={selected} initialTopic={topicParam || undefined} />
    </div>
  );
}
