  ...
  return (
    <div className="space-y-4 fade-in pt-2">
      <div>
        ...
        <p className="text-zinc-500 text-sm mt-0.5">Track your revision journey</p>
      </div>
        ...
        <div className="space-y-4 fade-in">
          {totalActivity === 0 ? (
            <div className="bg-white border border-zinc-200 rounded-2xl p-8 text-center shadow-sm">
              ...
              <p className="text-zinc-400 text-[13px] mt-1">Start practising to see your progress here</p>
